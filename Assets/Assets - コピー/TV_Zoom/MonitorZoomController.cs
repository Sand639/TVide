...
//            {
//                SetNoiseStrength(currentZoomIndex, defaultNoiseStrength);
//                SetScanlineStrength(currentZoomIndex, defaultScanlineStrength);

//                StartCoroutine(ZoomTo(monitorMasks[currentZoomIndex], Vector3.one, originalPositions[currentZoomIndex], null));
//                StartCoroutine(ZoomScaleOnly(monitors[currentZoomIndex], Vector3.one));
//            }
...
//                if (monitorRawImages != null && currentZoomIndex < monitorRawImages.Length)
//                {
//                    StartCoroutine(ZoomSize(monitorRawImages[currentZoomIndex].rectTransform, originalSizes[currentZoomIndex], false, originalRawImagePosX[currentZoomIndex]));
//                }
//            }
...
//            if (monitorRawImages != null && index < monitorRawImages.Length && index < zoomedSizes.Length)
//            {
//                StartCoroutine(ZoomSize(monitorRawImages[index].rectTransform, zoomedSizes[index], false, originalRawImagePosX[index]));
//            }
...
//    IEnumerator ZoomSize(RectTransform rectTransform, Vector2 targetSize, bool preserveY, float fixedPosX)
//    {
...
//            rectTransform.anchoredPosition = new Vector2(fixedPosX, rectTransform.anchoredPosition.y);
//            yield return null;
//        }
